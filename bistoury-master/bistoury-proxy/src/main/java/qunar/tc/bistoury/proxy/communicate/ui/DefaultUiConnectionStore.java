...
public class DefaultUiConnectionStore implements UiConnectionStore {
    ...
    public UiConnection register(Channel channel) {
        ...
        UiConnection oldConnection = connections.putIfAbsent(channel, connection); //If the specified key is not already associate * with a value, associate it with the given value.
